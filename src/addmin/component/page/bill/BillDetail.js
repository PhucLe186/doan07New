    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.info}>
                <p>
                    <strong>Khách hàng:</strong> {bill.customer}
                </p>
                <p>
                ...
                <p>
                    ...
                    <span className={bill.status === 'Đã thanh toán' ? styles.paid : styles.unpaid}>{bill.status}</span>
                </p>
            </div>
            ...
            <div className={styles.actions}>
                ...
                <Link to="/bill" className={styles.backButton}>
                    Quay lại danh sách
                </Link>
            </div>
        </div>
